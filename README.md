...
### Assumptions
 ...
 - You have Docker and Docker-Compose installed (Docker Desktop, get.docker.com and manual Compose installed for Linux).
...
### Getting Started
 ...
 - Requires install Maven, Java and SonarQube Scanner in Jenkins. For enables SonarQube Scanner see https://docs.sonarqube.org/latest/analysis/jenkins/ .
